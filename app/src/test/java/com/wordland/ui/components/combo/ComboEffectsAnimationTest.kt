...
/**
 * Unit tests for Combo Animation Effects
 *
 ...
 * - Milestone popup messages and styles
 */
@RunWith(JUnit4::class)
class ComboEffectsAnimationTest {
    // ========== Pop Animation Tests ==========
