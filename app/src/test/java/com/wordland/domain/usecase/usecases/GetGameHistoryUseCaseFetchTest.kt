...
/**
 * Unit tests for GetGameHistoryUseCase basic fetch operations
 *
 * Tests basic game history retrieval operations including
 * pagination, filtering by level/mode/date, and statistics.
 */
class GetGameHistoryUseCaseFetchTest {
