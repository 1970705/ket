...
/**
 * Seeder for Go Volcano content
 * Initializes Go Volcano levels and progress
 */
@Singleton
class GoVolcanoSeeder
    @Inject
    constructor(
        ...
        /**
         * Seed initial data for Go Volcano
         */
        fun seedGoVolcano() {
            // TODO: Implement Go Volcano seeding
